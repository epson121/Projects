...
[**Prime Factorization**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_prime_factorization) – Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_next_prime) – Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_tiles_cost_calculator) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.

[**Mortgage Calculator**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_mortgage_calculator) – Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan.

[**Change Return Program**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_change_return) – The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.

[**Binary to Decimal and Back Converter**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_binary_decimal_converter) – Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.

[**Calculator**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_calculator) – A simple calculator to do basic operators. Make it a scientific calculator for added complexity.

[**Unit Converter (temp, currency, volume, mass and more)**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_unit_converter) – Converts various units between one another. The user enters the type of unit being entered, the type of unit they want to convert to and then the value. The program will then make the conversion.

[**Alarm Clock**](https://github.com/epson121/Projects/tree/master/Numbers/numbers_alarm_clock) – A simple clock where it plays a sound after X number of minutes/seconds or at a particular time.
...
[**Reverse a String**](https://github.com/epson121/Ruby/tree/master/various) – Enter a string and the program will reverse it and print it out.

[**Pig Latin**](https://github.com/epson121/Ruby/tree/master/various) – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](https://github.com/epson121/Ruby/tree/master/various) – Enter a string and the program counts the number of vowels in the text.

[**Check if Palindrome**](https://github.com/epson121/Ruby/tree/master/various) – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”
...
[**Address Book**](https://github.com/epson121/ember-contact-list) – Keep track of various contacts, their numbers, emails and little notes about them like a Rolodex in the database. For extra complexity, allow the user to connect to a website publish their address book based on specific options the user has set. (Rails + EmberJS)
